...
- Attestation #1
  ...
  - Build workflow:. .github/workflows/goreleaser.yml@refs/tags/v0.7.0
  - Signer repo:.... mikesmitty/file-search
  - Signer workflow: .github/workflows/goreleaser.yml@refs/tags/v0.7.0
```
...
```bash
cosign verify-blob \
  --certificate-identity "https://github.com/mikesmitty/file-search/.github/workflows/release.yml@refs/tags/v0.7.0" \
